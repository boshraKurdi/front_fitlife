        ...
        <div className="headtittle">
          <div>
            ...
            <h2 style={{ display: "flex", alignItems: "center" }}>
              <EmailIcon style={{ marginRight: ".5rem" }} />
              {profile?.email}
            </h2>
            {/* <h2><LocationOnIcon/> syria , aleppo</h2> */}
          </div>
          <div style={{ display: "flex", alignItems: "center" }}>
            <NavLink to="edit" className="btn_profile">
              <EditIcon />
              {language == "ar" ? "تعديل الملف الشخصي" : "edit profile"}
            </NavLink>
            <button onClick={HandelDelete} className="btn_profile_delete">
              <DeleteIcon />
            ...
            >
                ...
                <div className="balance-card">
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <h2 className="balance">
                      {profile?.mygoal &&
                        profile?.mygoal[0]?.calories_max +
                          " - " +
                          profile?.mygoal[0]?.calories_min}
                    </h2>
              ...
              <div className="col">
                <div className="total-invoice">
                  <h3 className="cardtittle">
                    {language == "ar" ? "الوزن الصحي" : "Healthy Weight"}
                  </h3>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    <h2 className="balance">
                      {profile?.width}kg / {profile?.height}cm
                    </h2>
                    <span
              ...
              <div className="col">
                <div className="paid-invoice">
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <h2 className="balance">
                      you sleep {profile.sleepForDay}h{" "}
                      {language == "ar" ? "من" : "from"} 8h
                    </h2>
            ...
            >
              ...
              <div className="col">
                <div className="latest-activity">
                  ...
                  >
                    {language == "ar" ? "اهدافي" : "My Goals"}{" "}
                    <EditIcon className="edit_week_day" />
                  </h3>
                  <div className="pather_day_week">
                    {profile?.goals?.map((el) => {
                      return (
                        <>
                          <div onClick={()=>{
                            nav(`progressGoal/${el.goal_id}`)
                          }} className="day_week" style={{cursor:"pointer"}}>
                            {/* <CheckCircleIcon className="true" /> */}
                            <div className="st" style={{background:(el.active == 2 || el.active == 0) ?"#ff0066" : "#339933"}}>
                            {el.active == 1 ?(language === "en" ?"now" :"هدفي الحالي") :el.active == 2 ?(language === "en" ?"old" :"هدف منتهي")  : (language === "en" ?"process" :"قيد المعالجة") }
                            </div>
                            <span>
                              {language === "en"
                                ?el.title

...
const DetailsGym = () => {
  ...
  const newData = gym.section
    ? gym.section.map((data) => {
        return (
          <>
            <CardContentDetails
  ...
  return (
    <Box m="20px">
      <Header
        title={language === "en" ? "DETAILS GYM" : "تفاصيل النادي"}
        subtitle={language === "en" ? "Information Gym" : "معلومات النادي"}
      />
      {loadingShow === "pending" ? (
        "loading..."
      ) : (
              ...
              >
                ...
                <Box m="15px">
                  <TextField
                    ...
                    sx={{ height: "80px" }}
                    defaultValue={
                      language === "en" ? gym?.description : gym?.description_ar
                    }
                    multiline
                    maxRows={2}
                    InputLabelProps={{
